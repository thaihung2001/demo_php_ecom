            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6">
                    <div class="main-slider-content">
                        <span class="subtitle"><i class="fas fa-fire"></i>Mua ngay khi còn ưu đãi 🌟</span>
                        <h1 class="title">Ở đâu có ý chí, ở đó có con đường!</h1>
                        <!-- <div class="shop-btn">
                  <a
            ...
            <div class="product-area pb--50">
                <div class="section-title-wrapper">
                    <span class="title-highlighter highlighter-primary">
                        <i class="far fa-shopping-basket"></i>Tháng này</span>
                    <h2 class="title">Những sản phẩm nổi tiếng</h2>
                </div>
                <div
                    ...
                    <div class="product-isotope-heading">
                        <div class="section-title-wrapper">
                            <span class="title-highlighter highlighter-primary"><i class="far fa-shopping-basket"></i>
                                Sản phẩm mới của chúng tôi</span>
                            <h2 class="title">Những sản phẩm mới</h2>
                        </div>
