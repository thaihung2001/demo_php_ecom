        ...
        <div class="container">
            <div class="axil-product-cart-wrap">
                <div class="product-table-heading">
                    ...
                    <a href="fashionApp.php?act=clear_cart" class="cart-clear">Làm rỗng giỏ hàng</a>
                </div>
                    ...
                    <table class="table axil-product-table axil-cart-table mb--40">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="product-size">Kích cỡ</th>
                                        ...
                                        <div class="cart-update-btn-area">
                                            <div class="input-group product-cupon">
                                                ...
                                                <div class="product-cupon-btn">
                                                    <button type="submit" class="axil-btn btn-outline">Dùng</button>
                                                </div>
                                            </div>
                                            <div class="update-btn">
                                                <a href="fashionApp.php" class="axil-btn btn-outline">Tiếp tục mua hàng</a>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xl-5 col-lg-7 offset-xl-7 offset-lg-5">
                                                <div class="axil-order-summery mt--80">
                                                    <h5 class="title mb--20">Tóm tắt đơn đặt hàng</h5>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <label for="radio2">Cửa hàng : 30,000đ</label>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                            ...
                                                                            <div class="single-payment">
                                                                                <div class="input-group">
                                                                                    ...
                                                                                    <label for="radio5">Trả tiền mặt</label>
                                                                                </div>
                                                                            </div>                                                                            
                                                                        </div>
                                                                    </td>
