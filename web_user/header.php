            ...
            <div class="header-navbar">
                ...
                <div class="header-main-nav">
                    ...
                    <nav class="mainmenu-nav">
                        ...
                        <ul class="mainmenu">
                            <li>
                                <a href="fashionApp.php?act=home">Trang Chủ</a>
                            </li>
                      ...
                      ?>
                            ...
                            <li><a href="fashionApp.php?act=about">Giới thiệu</a></li>
                        </ul>
                    </nav>
                    <!-- End Mainmanu Nav -->
                </div>
                    ...
                    <ul class="action-list">
                        <li class="axil-search d-xl-block d-none">
                            <input type="search" class="placeholder product-search-input" name="search2" id="search2"
                                value="" maxlength="128" placeholder="Hôm nay bạn cần tìm gì?" autocomplete="off" />
                        ...
                        if(isset($_SESSION['username'])&&($_SESSION['username']!=""))
                        {
                          echo '
                          <div class="login-btn">
                          <li><a class="axil-btn btn-bg-primary" style="text-align: center;" href="fashionApp.php?act=account_user">Tài khoản của tôi</a></li>
                          </div>
                          </ul>
                          <div class="login-btn">
                            <a href="fashionApp.php?act=logout" class="axil-btn btn-bg-primary">Đăng xuất</a>
                          </div>
                          ';
                        } else {
                          echo '
                          <div class="login-btn">
                          <a href="fashionApp.php?act=login" class="axil-btn btn-bg-primary">Đăng nhập</a>
                          </div>
                          <div class="login-btn">
                          <a href="fashionApp.php?act=insert_client_user&id=1" class="axil-btn btn-bg-primary">Đăng ký</a>
                          </div>';
                        }?>
                            </div>
                        </li>
